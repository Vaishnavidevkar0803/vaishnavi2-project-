...
public class CF_TC_56_ValidateSortPlanButton extends BaseClass 
{
...
//		Thread.sleep(2000);
//		Assert.assertNotEquals(textResult,testResultFromBanner ,"text result is equal to the banner result,TC is failed");
//		
//		//if the tc passed 
...
//	}
	@Test
	public void valiadate_sortPlanButton() throws InterruptedException
	{
		Thread.sleep(5000);
		Assert.assertTrue(true, "sort plan button is not present ,TC is Failed");
		resultPage.sortPlanElementPresency();
	}
	@AfterMethod
